...
import ProfilePic from "../public/profile-2.jpg";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Manisha.</span> I&apos;m a{" "}
        ...
        building <span className="font-bold">Websites</span>. Focused on solving{" "}
        <span className="underline">real-world problems.</span>.
      </motion.h1>
      <motion.div
        initial={{ opacity: 0, y: 100 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        ...
        <a
          ...
          href="/Ratlavath_Manisha_Resume (1).pdf"
          download
        >
          Download resume{" "}
        ...
        <a
          href="https://www.linkedin.com/in/ratlavath-manisha-45baa6242/"
          target="_blank"
        ...
        <a
          href="https://github.com/Manisha01407"
          target="_blank"
